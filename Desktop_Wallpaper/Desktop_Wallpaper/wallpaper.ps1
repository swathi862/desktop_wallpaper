...
$json = Invoke-WebRequest 'https://api.nasa.gov/planetary/apod?concept_tags=True&date=2024-03-05&api_key=Ec8ixequm0WkHlnG8R8ylMsaxW6tyRFip0Ws7Cir'
#Check to see if media-type = 'image' 
$url = ConvertFrom-Json $json | Select-Object -ExpandProperty 'hdurl'

$media_type = ConvertFrom-Json $json | Select-Object -ExpandProperty 'media_type'
# if media_type == video, return

# Write-Host $url

$path = 'C:\wallpapers\APOD.jpg'
